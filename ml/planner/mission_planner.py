...
class MissionPlanner:
    ...
    Args:
        allocator : TaskAllocationStrategy for RESCUE-phase tasking.
    ...
    def __init__(self, allocator=None, zone_grid=None):
    ...
    def begin_mission(self, env):
        ...
        Builds one MissionObjective per environment target and issues the
        opening SEARCH directives. Call immediately after `env.reset()`.
        """
        objectives = {
